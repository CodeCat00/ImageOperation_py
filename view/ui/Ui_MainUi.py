...
"            ")
        ...
        self.actionApproxPolyDP = QAction(MainUi)
        self.actionApproxPolyDP.setObjectName(u"actionApproxPolyDP")
        self.actionConvexHull = QAction(MainUi)
        self.actionConvexHull.setObjectName(u"actionConvexHull")
        self.actionDrawContours = QAction(MainUi)
        self.actionDrawContours.setObjectName(u"actionDrawContours")
        self.actionCircle = QAction(MainUi)
        self.actionCircle.setObjectName(u"actionCircle")
        self.actionEllipse = QAction(MainUi)
        ...
        self.tabInnerWidget2.setGeometry(QRect(0, 0, 98, 40))
        ...
        self.tabInnerWidget3.setGeometry(QRect(0, 0, 98, 40))
        ...
        self.tabInnerWidget4.setGeometry(QRect(0, 0, 98, 40))
        ...
        self.tabInnerWidget5.setGeometry(QRect(0, 0, 98, 40))
        ...
        self.menuOpenCV.addAction(self.menu_5.menuAction())
        ...
        self.menu_5.addAction(self.actionApproxPolyDP)
        self.menu_5.addAction(self.actionConvexHull)
        self.menu_5.addAction(self.actionDrawContours)
    ...
    def retranslateUi(self, MainUi):
...
#if QT_CONFIG(shortcut)
        self.actionOpenFilePath.setShortcut(QCoreApplication.translate("MainUi", u"Ctrl+F", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.actionApproxPolyDP.setText(QCoreApplication.translate("MainUi", u"\u8f6e\u5ed3\u8fd1\u4f3c", None))
        self.actionConvexHull.setText(QCoreApplication.translate("MainUi", u"\u51f8\u5305", None))
        self.actionDrawContours.setText(QCoreApplication.translate("MainUi", u"\u65cb\u8f6c\u77e9\u5f62", None))
