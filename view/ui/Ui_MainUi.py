...
"            ")
        ...
        self.menu.addAction(self.actionSimpleBinaryThreshold)
        self.menu.addAction(self.actionSimpleBinaryInvThreshold)
        self.menu.addAction(self.actionSimpleTruncThreshold)
        self.menu.addAction(self.actionSimpleToZeroThreshold)
    ...
    def retranslateUi(self, MainUi):
        ...
        self.menu.setTitle(QCoreApplication.translate("MainUi", u"\u56fe\u50cf\u9608\u503c", None))
    # retranslateUi
